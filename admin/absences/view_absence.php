        ...
        <tbody>
            <?php foreach ($absences as $absence) : ?>
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='edit_absence.php?id=<?php echo $absence['id_absence']; ?>'">Modifier</button>
                        <button onclick="location.href='delete_absence.php?id=<?php echo $absence['id_absence']; ?>'">Supprimer</button>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
